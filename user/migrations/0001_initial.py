...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Cash_on_Delivey_Orders',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=254, verbose_name='Customer Name')),
                ('amount', models.FloatField(verbose_name='Amount')),
                ('email', models.CharField(blank=True, max_length=254, null=True, verbose_name='Email Address')),
                ('landmark', models.CharField(blank=True, max_length=254, null=True, verbose_name='Land Mark')),
                ('address', models.CharField(blank=True, max_length=254, null=True, verbose_name='Address')),
                ('contact', models.FloatField(blank=True, null=True, verbose_name='Contact')),
            ],
        ),
        migrations.CreateModel(
            name='Category',
